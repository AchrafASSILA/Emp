...
<?php if (isset($_SESSION['alogin'])) : ?>
	...
	if (isset($_POST['add_head'])) {
		...
		$cmd = mysqli_query($conn, "select * from tblemployees WHERE role='Head' AND Department = '$department'");
		$int = mysqli_num_rows($cmd);
		$query = mysqli_query($conn, "select * from tblemployees where EmailId = '$email'");
		$count = mysqli_num_rows($query);
		if ($int > 0) {

			echo "<script>alert('Department already has a Head')</script>";
		} else if ($count > 0) { ?>
			<script>
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-12">
											<div class="form-group">
												...
												<select name="department" class="custom-select form-control" autocomplete="off">
									...
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="form-group">
												...
												<input name="salary" type="text" class="form-control" required="true" autocomplete="off">
											</div>
										</div>
										...
										<div class="col-md-4 col-sm-12">
											<div class="form-group">
												...
												<input name="strt" type="text" class="form-control date-picker" required="true" autocomplete="off">
										...
										<div class="col-md-4 col-sm-12">
											<div class="form-group">
												...
												<div class="modal-footer justify-content-center">
													<button class="btn" style="background: #2196f3;color: white;" name="add_head" id="add_head" data-toggle="modal">Add&nbsp;Head</button>
												</div>
											</div>
										</div>
									</div>
