...
<?php if (isset($_SESSION['alogin'])) : ?>
	...
	if (isset($_POST['new_update'])) {
		...
		$result = mysqli_query($conn, "update admin set FirstName='$fname', LastName='$lname',  Gender='$gender', Dob='$dob',Address='$address', Phonenumber='$phonenumber' where emp_id='$session_id'         
		");
		if ($result) {
												...
												<div class="profile-setting">
													<form method="POST" enctype="multipart/form-data">
														<div class="profile-edit-list row">
															...
															<div class="weight-500 col-md-12" style="justify-content: center;">
																<div class="form-group">
																	<label></label>
																	<div class="modal-footer justify-content-center">
																		<button class="btn" style="background: #03a9f4;color: white;" name="new_update" id="new_update" data-toggle="modal">Save & &nbsp;Update</button>
																	</div>
																</div>
															</div>
														</div>
